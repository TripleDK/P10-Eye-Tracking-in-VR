...
public class MarketWith2DCalibration : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Debug.Log("isConnected " + PupilTools.IsConnected + ", isGazing " + PupilTools.IsGazing);
        if (PupilTools.IsConnected && PupilTools.IsGazing)
        {
            Debug.Log("Left: " + PupilData._2D.GetEyePosition(sceneCamera, PupilData.leftEyeID) + ", Center: " + PupilData._2D.GazePosition);
