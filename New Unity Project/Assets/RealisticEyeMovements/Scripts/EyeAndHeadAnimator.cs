    ...
    public class EyeAndHeadAnimator : MonoBehaviour
    {
        ...
        void DrawSightlinesInEditor()
        {
            if (controlData.eyeControl != ControlData.EyeControl.None)
            {
                ...
                Vector3 avgDir = ((leftDirection + rightDirection) / 2).normalized;
                lookAtPosition = (leftEyeAnchor.position + rightEyeAnchor.position) / 2 + avgDir * 10;
        ...
        public void Initialize()
        {
            ...
            if (createdTargetXforms[0] == null)
            {
                ...
                createdTargetXforms[0].parent = transform;
            ...
            if (createdTargetXforms[1] == null)
            {
                ...
                createdTargetXforms[1].parent = transform;
