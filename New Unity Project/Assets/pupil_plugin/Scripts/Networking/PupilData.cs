...
public static class PupilData
{
    ...
    private static string rightDiameter3dKey = "diameter_3d" + "_" + rightEyeID;
    public static EyeData rightDiameter3d
    {
        get
        {
            if (!eyeData.ContainsKey(rightDiameter3dKey))
                eyeData.Add(rightDiameter3dKey, new EyeData(SamplesCount));
            return eyeData[rightDiameter3dKey];
        }
    }
    ...
    public static class _3D
    {
        ...
        public static double RightDiameter3D
        {
            get
            {
                return 0.0;
                //     return rightDiameter3d.Raw;
            }
        }
    }
