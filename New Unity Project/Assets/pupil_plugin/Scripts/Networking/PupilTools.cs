...
public class PupilTools : MonoBehaviour
{
    ...
    public static List<float> calibrationConfidenceLeft = new List<float>();
    public static float calibrationConfidenceLeftAvg = 0.5f;
    public static List<float> calibrationConfidenceRight = new List<float>();
    public static float calibrationConfidenceRightAvg = 0.5f;
    public static void UpdateCalibrationConfidence(string eyeID, float confidence)
    {
        ...
        if (eyeID == "0")
        { calibrationConfidenceRight.Add(confidence); }
        if (eyeID == "1")
        { calibrationConfidenceLeft.Add(confidence); }
