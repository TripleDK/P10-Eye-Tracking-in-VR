...
public class PupilManager : MonoBehaviour
{
    ...
    public GazeDirectionPupil gazeDir;
    ...
    void ShowCalibrate()
    {
        ...
        calibrationText.text = "Press the menu button on either controller to start calibration.";
    }
    ...
    {
        calibrationText.text = "Calibration failed\nPress the menu button on either controller to start calibration.";
